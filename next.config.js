  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: '/:slug',
        permanent: false,
      }, //try to force cache update again again hello
      ...
      { source: '/2022', destination: '/the-2022-ministry-plan', permanent: true },
      ...
      { source: '/budget', destination: '/the-2022-ministry-plan', permanent: true },
      ...
      { source: '/vision', destination: '/the-2022-ministry-plan', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/48954698', permanent: true }
    ];
  },
};
